...
namespace Lab2_6BiblWorm
{
    public partial class Form1 : Form
    {
        ...
        public string Named // Название
        {
            get { return textBox4.Text; }
            set { textBox4.Text = value; }
        }
        public string Editor// Редактор
        {
            get { return textBox6.Text; }
            set { textBox6.Text = value; }
        }

        public int Pagejournal // Количество страниц
        {
            get { return (int)numericUpDown5.Value; }
            set { numericUpDown5.Value = value; }
        }

        public int Release // Год выпуска
        {
            get { return (int)numericUpDown6.Value; }
            set { numericUpDown6.Value = value; }
        }

        public int inventorynumber// Инвентарный номер
        {
            get { return (int)numericUpDown7.Value; }
            set { numericUpDown7.Value = value; }
        }
        public bool availability // Наличие
        {
            get { return checkBox4.Checked; }
            set { checkBox4.Checked = value; }
        }
        public bool Sortinventorynumber // Сортировка по инвентарному номеру
        {
            get { return checkBox3.Checked; }
            set { checkBox3.Checked = value; }
        }
        public bool ReturnonTime // Возвращение в срок
        {
            get { return checkBox5.Checked; }
            set { checkBox5.Checked = value; }
        }
        public int Periodofuse// Срок пользования
        {
...
Page, Year, InvNumber, Existence);
        ...
        {
            Journal b = new Journal(Named, Editor, Pagejournal, Release, inventorynumber, availability);
            if (ReturnonTime)
                b.ReturnSrok();
            b.PriceJournal(Periodofuse);
            its.Add(b);

            Author = Title = PublishHouse = "";
            Page = InvNumber = PeriodUse = 10;
            Year = 2010;
            Existence = ReturnTime = false;
